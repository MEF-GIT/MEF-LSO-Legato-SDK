...
- [6. API Interactions and Flows](#6-api-interactions-and-flows)
  ...
  - [6.7. Use Case 7: Retrieve List of Test Jobs](#67-use-case-7-retrieve-list-of-test-jobs)
  - [6.8. Use Case 8: Retrieve Test Job by Job Identifier](#68-use-case-8-retrieve-test-job-by-job-identifier)
  - [6.9. Use Case 9: Modify Test Job](#69-use-case-9-modify-test-job)
  ...
  - [6.10. Use Case 10: Retrieve Modify Test Job List](#610-use-case-10-retrieve-modify-test-job-list)
  - [6.11. Use Case 11: Retrieve Modify Test Job by Identifier](#611-use-case-11-retrieve-modify-test-job-by-identifier)
  - [6.12. Use Case 12: Cancel Test Job](#612-use-case-12-cancel-test-job)
    - [6.12.1. Interaction flow](#6121-interaction-flow)
    - [6.12.2. Cancel Test Job Request](#6122-cancel-test-job-request)
    - [6.12.3. Cancel Test Job Response](#6123-cancel-test-job-response)
    - [6.12.4. Cancel Test Job State Machine](#6124-cancel-test-job-state-machine)
  - [6.13. Use Case 13: Retrieve Cancel Test Job List](#613-use-case-13-retrieve-cancel-test-job-list)
  - [6.14. Use Case 14: Retrieve Cancel Test Job by Identifier](#614-use-case-14-retrieve-cancel-test-job-by-identifier)
  - [6.15. Use Case 15: Suspend Test Job](#615-use-case-15-suspend-test-job)
    - [6.15.1. Interaction flow](#6151-interaction-flow)
    - [6.15.2. Suspend Test Job Request](#6152-suspend-test-job-request)
    - [6.15.3. Suspend Test Job Response](#6153-suspend-test-job-response)
    - [6.15.4. Suspend Test Job State Machine](#6154-suspend-test-job-state-machine)
  - [6.16. Use Case 16: Retrieve Suspend Test Job List](#616-use-case-16-retrieve-suspend-test-job-list)
  - [6.17. Use Case 17: Retrieve Suspend Test Job by Identifier](#617-use-case-17-retrieve-suspend-test-job-by-identifier)
  - [6.18. Use Case 18: Resume Test Job](#618-use-case-18-resume-test-job)
    - [6.18.1. Interaction flow](#6181-interaction-flow)
    - [6.18.2. Resume Test Job Request](#6182-resume-test-job-request)
    - [6.18.3. Resume Test Job Response](#6183-resume-test-job-response)
    - [6.18.4. Resume Test Job State Machine](#6184-resume-test-job-state-machine)
  - [6.19. Use Case 19: Retrieve Resume Test Job List](#619-use-case-19-retrieve-resume-test-job-list)
  - [6.20. Use Case 20: Retrieve Resume Test Job by Identifier](#620-use-case-20-retrieve-resume-test-job-by-identifier)
  - [6.21. Use Case 21: Retrieve Test Result List](#621-use-case-21-retrieve-test-result-list)
  - [6.22. Use Case 22: Retrieve Test Result by Test Result Identifier](#622-use-case-22-retrieve-test-result-by-test-result-identifier)
  ...
  - [6.25. Use Case 25: Unregister for Notifications](#625-use-case-25-unregister-for-notifications)
- [7. API Details](#7-api-details)
  ...
  - [7.3. API Data model](#73-api-data-model)
    ...
    - [7.3.4 Test Result](#734-test-result)
      ...
      - [7.3.4.3 Type ServiceSpecificTestResultConfiguration](#7343-type-servicespecifictestresultconfiguration)
  ...
  - [7.4.1 Test Job Notification API Data model](#741-test-job-notification-api-data-model)
    ...
    - [7.4.1.4. Type ResumeTestJobProcessStateChangeEvent](#7414-type-resumetestjobprocessstatechangeevent)
    - [7.4.1.5. Type SuspendTestJobProcessStateChangeEvent](#7415-type-suspendtestjobprocessstatechangeevent)
...
are defined in [[Mplify 136.1](#8-references)]. The requirements and use cases
are the same for all IRPs. This standard consists of this document and
complementary API definitions for Service Function Testing Management and
...
commit id:
[0ac5d97e881507a3e9750a2784246d49b7905848](https://github.com/MEF-GIT/MEF-LSO-Allegro-SDK/tree/0ac5d97e881507a3e9750a2784246d49b7905848)

- [`serviceApi/sft/serviceFunctionTest.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Allegro-SDK/0ac5d97e881507a3e9750a2784246d49b7905848/serviceApi/sft/serviceFunctionTest.api.yaml)
- [`serviceApi/sft/serviceFunctionTestNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Allegro-SDK/0ac5d97e881507a3e9750a2784246d49b7905848/serviceApi/sft/serviceFunctionTestNotification.api.yaml)

[MEF-LSO-Interlude-SDK](https://github.com/MEF-GIT/MEF-LSO-Interlude-SDK)

commit id:
[1179c709a465a86987702ba4aa0f7846dcf68e37](https://github.com/MEF-GIT/MEF-LSO-Interlude-SDK/tree/1179c709a465a86987702ba4aa0f7846dcf68e37)

- [`serviceApi/sft/serviceFunctionTest.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Interlude-SDK/1179c709a465a86987702ba4aa0f7846dcf68e37/serviceApi/sft/serviceFunctionTest.api.yaml)
- [`serviceApi/sft/serviceFunctionTestNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Interlude-SDK/1179c709a465a86987702ba4aa0f7846dcf68e37/serviceApi/sft/serviceFunctionTestNotification.api.yaml)

[MEF-LSO-Legato-SDK](https://github.com/MEF-GIT/MEF-LSO-Legato-SDK)

commit id:
[84a92bb18893bdfdc5b5fe4a8f685f5180e7a9a0](https://github.com/MEF-GIT/MEF-LSO-Legato-SDK/tree/84a92bb18893bdfdc5b5fe4a8f685f5180e7a9a0)

- [`serviceApi/sft/serviceFunctionTest.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Legato-SDK/84a92bb18893bdfdc5b5fe4a8f685f5180e7a9a0/serviceApi/sft/serviceFunctionTest.api.yaml)
- [`serviceApi/sft/serviceFunctionTestNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Legato-SDK/84a92bb18893bdfdc5b5fe4a8f685f5180e7a9a0/serviceApi/sft/serviceFunctionTestNotification.api.yaml)
...
| SFT      | Service Function Testing                                                                     | Mplify 136.1                                             |
...
cases that are defined in [[Mplify 136.1](#8-references)]. The API definition
builds on TMF Open API (v4.1.0) for Service Test Management
...
This Developer Guide does not define Mplify SFT Specifications but can be used
in combination with any SFT Specifications defined by or compliant with Mplify.
...
Figures 6, 7 and 8 presents a high-level use case diagrams. They aim to help
understand the endpoint mapping. Use cases are described extensively in
[chapter 6](#6-api-interactions-and-flows).

![Figure 6: Test Profile Use cases](serviceTest/media/sftTestProfileUsecases.png)

**Figure 6. Test Profile Use cases**

![Figure 7: Test Job Use cases](serviceTest/media/sftTestJobUsecases.png)

**Figure 7. Test Job Use cases**

![Figure 8: Test Result and Notification Use cases](serviceTest/media/sftNotificationUsecases.png)

**Figure 8. Test Result and Notification Use cases**
...
`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/allegro/serviceFunctionTesting/v3/`

**Base URL for Interlude**:

`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/interlude/serviceFunctionTesting/v3/`

**Base URL for Legato**:

`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/legato/serviceFunctionTesting/v3/`
...
| DELETE /testProfile/{id} | A request initiated by the Buyer/Client to delete a Test Profile in the Seller/Server system.           | 3                             |
...
`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/allegro/serviceFunctionTestingNotification/v3/`

**Base URL for Interlude**:

`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/interlude/serviceFunctionTestingNotification/v3/`

**Base URL for Legato**:

`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/legato/serviceFunctionTestingNotification/v3/`
...
- `ServiceSpecificTestResultConfiguration` - this type is extended with Test
...
for Mplify standard service schemas is in URN format and is assigned by Mplify.
This identifier is provided as root schema `$id`. Use of Non-Mplify standard
service testing configuration is allowed. In such a case the schema identifier
must be agreed upon between the Buyer/Client and the Seller/Server.
...
In terms of test measures and test results, the appropriate payloads are
introduced via `ServiceSpecificTestJobConfiguration` and
`ServiceSpecificTestResultConfiguration` respectively.
...
`ServiceSpecificTestResultConfiguration` as described in the OAS specification.
This pattern is referred to as **Static Binding**. The snippets below present
...
ServiceSpecificTestResultConfiguration:
  description:
    ServiceSpecificTestResultConfiguration is used as an extension point for
...
PingReport:
  allOf:
    - $ref: '#/components/schemas/ServiceSpecificTestResultConfiguration'
...
`ServiceSpecificTestResultConfiguration` types are extension points that
...
`ServiceSpecificTestJobConfiguration` and
`ServiceSpecificTestResultConfiguration` **MUST** be used to specify the type
...
![Figure 9: Extension pattern](serviceTest/media/extensionPattern.png)

**Figure 9. The Extension Pattern with Sample Service-Specific Extension**

Figure 9 presents Mplify Service Function Testing schemas that represent test
...
`"urn:mef:lso:spec:legato:ping-configuration:v0.0.1:all"` value. Finally, for
`ServiceSpecificTestResultConfiguration`, the `@type` attribute takes
...
| 23         | Register for Event Notifications            | The Buyer/Client requests to subscribe to Test Profile and/or Test Job Notifications.                                                                     | 17                            |
...
The flow of this use case is described in Figure 10.
![Figure 10: Use Case 1](serviceTest/media/useCase1.png)

**Figure 10. Use Case 1 - Test Profile create request flow**
...
![Figure 11: Test Profile Notification](serviceTest/media/useCase1Notification.png)

**Figure 11. Test Profile progress tracking - Notifications**

![Figure 12: Test Profile Polling](serviceTest/media/useCase1Polling.png)

**Figure 12. Test Profile progress tracking - Polling**
...
![Figure 13: Test Profile Key Entities](serviceTest/media/testProfileModel.png)

**Figure 13. Test Profile Key Entities**
...
presented in Figure 13. The Seller/Server responds with a `TestProfile` type,
...
Figure 14 presents the Test Profile Lifecycle Flow

![Figure 14: Test Profile Lifecycle Status Flow](serviceTest/media/testProfileLifecycleStatus.png)

**Figure 14. Test Profile Lifecycle Status Flow**
...
Table 8 presents the mapping between the `TestProfile` API `lifecycleState`
...
**Table 8. Test Profile Lifecycle states**
...
```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/testProfile?creationDate.gt="2024-08-12T23:20:50.52Z"&limit=10&offset=0
```
...
that match the filter criteria, they **MUST** return an empty list. [Mplify
136.1 R17]
...
![Figure 15: Use Case 3](serviceTest/media/useCase2Model.png)

**Figure 15. Use Case 3: Retrieve Test Profile by Profile Identifier - Model**
...
provided for this purpose. It includes only the attributes that are updatable
...
Figure 16 presents the model used in the PATCH request. The Seller/Server
responds with a `TestProfile` type which is a full representation of Test
Profile instance.

![Figure 16: Patch request Model](serviceTest/media/useCase4PatchModel.png)
...
"Retrieve Test Profile by Test Profile Identifier" request **MUST** include a
`TestProfile` with requested attributes updated. [Mplify 136.1 R9]
...
`DELETE /testProfile/{id}` endpoint. This operation only requires providing the
`id` in the path and has an empty `204` confirmation response.
...
![Figure 17: Delete Test Profile Flow](serviceTest/media/useCase5DeleteFlow.png)

**Figure 17. Delete Test Profile Flow**
...
![Figure 18: Use Case 6](serviceTest/media/useCase7.png)

**Figure 18. Use Case 6 - Test Job create request flow**
...
![Figure 19: Test Job Notification](serviceTest/media/useCase7Notification.png)

**Figure 19. Test Job progress tracking - Notifications**

![Figure 20: Test Job Polling](serviceTest/media/useCase7Polling.png)

**Figure 20. Test Job progress tracking - Polling**
...
![Figure 21: Test Job with Test Profile Key Entities](serviceTest/media/testJobModel.png)

**Figure 21. Test Job with Test Profile Key Entities**
...
```json
{
  ...
  "requestedEndDateTime": "2025-06-30T23:59:59Z",
  "requestedStartDateTime": "2025-06-29T23:59:59Z",
  "serviceSpecificTestJobConfiguration": {
...
presented in Figure 21. The Seller/Server responds with a `TestJob` type, which
...
Job request **MUST** echo back all Buyer/Client provided attributes. [Mplify
136.1 R29]
...
Figure 22 illustrates the key part of the data model that can be used during
...
![Figure 22: Test Job without Test Profile Key Entities](serviceTest/media/testJobWithoutTestProfileModel.png)

**Figure 22. Test Job without Test Profile Key Entities**
...
Entities used for providing a response to Create Test Job requests are
presented in Figure 22. The Seller/Server responds with a `TestJob` type, which
adds some attributes (like `id` or `state`) to the `TestJob_Common` that was
used in the Buyer/Client request.
...
{
  "id": "job-6789",
  "href": "https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/testJob/job-6789",
  "name": "PingTestJob-002",
  "description": "Ping test from ServiceA to ServiceB",
  "testProfile": {
    "@type": "TestProfileValue",
...
**[R36]** If the request is successful, the Seller **MUST** return the
following attributes:
...
Table 10 presents the mapping between the API `state` names and the Mplify
136.1 naming, together with the states' description.
...
| `assessingCancellation` | ASSESSING_CANCELLATION | A Cancel Test Job request is received while the Test Job is in the `inProgress`, `suspend` or `scheduled` state. If the Cancel Test Job request is approved, the Test Job moves to the `cancelled` state. If not, the Test Job returns to the `inProgress`, `suspend` or `scheduled` state.                                                                                                                                                                                                                                                                                                                                                                                                                |
| `assessingModification` | ASSESSING_MODIFICATION | A Modify Test Job request while the Test Job is in the `suspend` or `scheduled` state. If the Modify Test Job is accepted, the Test Job is updated. If the Modify Test Job is declined, the Test Job is not updated and returns to the `suspend` or `scheduled` state.                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
## 6.7. Use Case 7: Retrieve List of Test Jobs
...
- `testProfileId`
- `name`
- `requestedStartDateTime.gt`
- `requestedStartDateTime.lt`
- `requestedEndDateTime.gt`
- `requestedEndDateTime.lt`

[Mplify 136.1 R738]

```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/testJob?relatedServiceIdFrom=service-from-001&limit=10&offset=0
```
...
`TestJob_Find` objects that match the selected filter criteria. [Mplify 136.1
R79]
...
## 6.8. Use Case 8: Retrieve Test Job by Job Identifier

The Buyer/Client can get detailed information about the Test Job from the
Seller/Server by using a `GET /testJob/{id}` operation. The payload returned in
the response is a full representation of the Test Job and includes all
...
## 6.9. Use Case 9: Modify Test Job
...
```json
{
  "testJob": {
    "id": "job-12345",
    "href": "https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/testJob/job-12345"
  },
  ...
  "requestedStartDateTime": "2025-06-14T09:00:00Z",
  "requestedEndDateTime": "2025-06-14T10:00:00Z",
  "testProfile": {
    "@type": "TestProfileRef",
    "id": "tp-002"
  },
...
attributes' values as provided by Buyer/Client in the request. [Mplify 136.1
R61]
...
Table 11 presents the mapping between the API `state` names and the Mplify
136.1 naming, together with states description. The list of states is the same
...
## 6.10. Use Case 10: Retrieve Modify Test Job List
...
```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/modifyTestJob?state=acknowledged&limit=10&offset=0
```
...
## 6.11. Use Case 11: Retrieve Modify Test Job by Identifier
...
## 6.12. Use Case 12: Cancel Test Job
...
### 6.12.2. Cancel Test Job Request
...
until the end and only afterward action should be applied. [Mplify133.1 O16,
O26]

### 6.12.3. Cancel Test Job Response
...
```json
{
  ...
  "href": "https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/CancelTestJob/cancel-job-12345", << added by SOF >>
...
### 6.12.4. Cancel Test Job State Machine
...
state and related `TestJob` moves to `assessingCancellation` state. Next, the
Seller/Server performs all the remaining business and time-consuming
validations. At this point, an Error response cannot be provided anymore, so
the Cancel Test Job moves to a `rejected` state if some issues are found. The
`cancelTestJob.cancellationDeniedReason` acts as a placeholder to provide a
...
## 6.13. Use Case 13: Retrieve Cancel Test Job List
...
```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/cancelTestJob?state=acknowledged&limit=10&offset=0
```
...
## 6.14. Use Case 14: Retrieve Cancel Test Job by Identifier
...
## 6.15. Use Case 15: Suspend Test Job
...
### 6.15.2. Suspend Test Job Request
...
### 6.15.3. Suspend Test Job Response
...
```json
{
  ...
  "suspensionReason": "Suspend Test Job sample",
  "creationDate": "204-06-19T12:58:17.088Z", << added by SOF >>
  "href": "https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/suspendTestJob/suspend-job-12345", << added by SOF >>
...
### 6.15.4. Suspend Test Job State Machine
...
## 6.16. Use Case 16: Retrieve Suspend Test Job List
...
```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/suspendTestJob?state=acknowledged&limit=10&offset=0
```
...
## 6.17. Use Case 17: Retrieve Suspend Test Job by Identifier

The Buyer/Client can get detailed information about the Suspend Test Job from
the Seller/Server by using a `GET /suspendTestJob/{id}` operation. The payload
returned in the response is a full representation of Suspend Test Job and
includes all attributes the Buyer/Client has provided while sending a Suspend
Test Job create request, together with additional attributes set by
Seller/Server.
...
## 6.18. Use Case 18: Resume Test Job
...
### 6.18.2. Resume Test Job Request
...
### 6.18.3. Resume Test Job Response
...
```json
{
  ...
  "resumptionReason": "Resume Test Job sample",
  "creationDate": "204-06-19T12:58:17.088Z", << added by SOF >>
  "href": "https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/resumeTestJob/resume-job-12345", << added by SOF >>
...
resume the Test Job, and the Test Job remains in the `suspended` state. [Mplify
136.1 R49]
...
### 6.18.4. Resume Test Job State Machine
...
## 6.19. Use Case 19: Retrieve Resume Test Job List
...
```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/resumeTestJob?state=acknowledged&limit=10&offset=0
```
...
## 6.20. Use Case 20: Retrieve Resume Test Job by Identifier
...
## 6.21. Use Case 21: Retrieve Test Result List

The Buyer can retrieve a list of `TestResult_Common` by using a
`GET /testResult` operation with desired filtering criteria.

**[O13]** The Buyer/ClientResultRetrieve Test Result List request **MAY**
contain none or more of the following filter criteria: [Mplify 136.1 O5]
...
```
https://serverRoot/mefApi/legato/serviceFunctionTesting/v3/testResult?relatedServiceIdFrom=service-from-001&limit=10&offset=0
```
...
`TestResult_Common` objects that match the selected filter criteria. [Mplify
136.1 R38]
...
## 6.22. Use Case 22: Retrieve Test Result by Test Result Identifier

The Buyer/Client can get detailed information about the Test Result from the
Seller/Server by using a `GET /testResult/{id}` operation. The payload returned
in the response is a full representation of the Test Result and includes all
attributes, together with Test Result attributes set by Seller/Server.
...
```json
{
  ...
  "testJob": {
    "id": "job-12345",
    "href": "https://serverRoot/serviceFunctionTesting/v3/testJob/job-12345"
  },
  "ServiceSpecificTestResultConfiguration": {
    "@type": "urn:mef:lso:spec:legato:ping-report:v0.0.1:all",
    "interface": {
...
```json
{
  "callback": "https://buyer.mplify.com/listenerEndpoint"
}
```
...
- `https://buyer.mplify.com/listenerEndpoint/mefApi/legato/serviceFunctionTestingNotification/v3/listener/testJobStateChangeEvent`
...
- Modification: When a modify request is accepted, a
  ...
  `testJobStateChangeEvent` indicating the `assessingModification` state. If
...
## 6.25. Use Case 25: Unregister for Notifications
...
compliance with rules defined in [[RFC7231](#8-references)]. In such case the
...
<table id="T_Error">
    ...
    <tbody>
        <tr>
            ...
            <td>reason*</td>
            <td>string<br/><span style="font-size:15px;font-style:italic">maxLength = 255</span></td>
            <td>Text that explains the reason for the error. This can be shown to a client user.</td>
        </tr><tr>
            <td>referenceError</td>
            <td>uri<br/><span style="font-size:15px;font-style:italic">format = uri</span></td>
...
related to them, and mapping to Mplify 136.1 specification are discussed later
in this section.
...
<table id="T_TestJob" style="width:100%">
    ...
    <tbody>
        ...
        <td>actualStartDateTime</td>
            <td>date-time<br/><span style="font-size:15px;font-style:italic">format = date-time</span></td>
            <td>O</td>
...
<table id="T_TestJob_Common" style="width:100%">
    ...
    <tbody>
        ...
        <td>requestedStartDateTime</td>
            <td>date-time<br/><span style="font-size:15px;font-style:italic">format = date-time</span></td>
            <td>O</td>
            <td>The start date and time of the Test Job. If the Buyer desires to schedule a test, this is a future date/time. If the Buyer desires an immediate test, this is empty.</td>
            <td>Start Date Time</td>
        </tr><tr>
        <td>requestedEndDateTime</td>
            <td>date-time<br/><span style="font-size:15px;font-style:italic">format = date-time</span></td>
            <td>M</td>
        ...
        <td>serviceSpecificTestJob Configuration</td>
            <td><a href="#T_ServiceSpecificTestJobConfiguration">ServiceSpecificTestJob Configuration</a></td>
            <td>M</td>
            <td></td>
...
<table id="T_TestJob_Find" style="width:100%">
    ...
    <tbody>
        ...
        <td>testProfile</td>
            <td><a href="#T_TestProfileRefOrValue">TestProfile RefOrValue</a></td>
            <td>M</td>
            <td></td>
            <td>r</td>
        </tr>
...
<table id="T_Duration" style="width:100%">
    ...
    <tbody>
        <tr>
        <td>amount</td>
            <td>integer<br/><span style="font-size:15px;font-style:italic">minimum = 0</span></td>
            <td>M</td>
...
<table id="T_CancelTestJob" style="width:100%">
    ...
    <tbody>
        ...
        <td>state</td>
            <td><a href="#T_TestJobProcessStateType">TestJob ProcessStateType</a></td>
            <td>M</td>
            <td></td>
...
<table id="T_TestProfile_Common" style="width:100%">
    ...
    <tbody>
        ...
        <td>lifecycleStatus</td>
            <td><a href="#T_TestProfileLifecycleStatusType">TestProfileLifecycle StatusType</a></td>
            <td>O</td>
            <td></td>
        ...
        <td>testProfile Relationship</td>
            <td><a href="#T_TestProfileRelationship">TestProfile Relationship</a>[]</td>
            <td>O</td>
            <td>Test profile may relate to more than one sub Test Profiles.</td>
            <td>Test Profile Relationship</td>
        </tr><tr>
        <td>serviceSpecific TestProfileConfiguration</td>
            <td><a href="#T_ServiceSpecificTestProfileConfiguration">ServiceSpecific TestProfileConfiguration</a></td>
            <td>O</td>
            <td></td>
            <td>Service Specific Test Profile Configuration</td>
        </tr><tr>
        <td>relatedService Specification</td>
            <td><a href="#T_ServiceSpecificationRef">Service SpecificationRef</a></td>
            <td>O</td>
            <td></td>
            <td></td>
        </tr><tr>
...
<table id="T_TestProfileRelationship" style="width:100%">
    ...
    <tbody>
        ...
        <td>role</td>
            <td><a href="#T_TestProfileRelationshipRole">TestProfile RelationshipRole</a></td>
            <td>M</td>
            <td></td>
...
<table id="T_TestResult" style="width:100%">
    ...
    <tbody>
        <tr>
        <td>ServiceSpecificTestResultConfiguration</td>
            <td><a href="#T_ServiceSpecificTestResultConfiguration">ServiceSpecificTestResultConfiguration</a></td>
            <td>M</td>
            <td></td>
            <td></td>
        </tr>
...
#### 7.3.4.3 Type ServiceSpecificTestResultConfiguration

**Description:** ServiceSpecificTestResultConfiguration is used as an extension
point for schema to be used that defines the Test Result attributes. The
`@type` attribute is used as a discriminator.

<table id="T_ServiceSpecificTestResultConfiguration" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
<table id="T_EventSubscriptionInput" style="width:100%">
    ...
    <tbody>
        ...
        <td>callback</td>
            <td>string</td>
            <td>M</td>
            <td>This callback value must be set to *host* property from SFT Notification API (serviceFunctionTestNotification.api.yaml). This property is appended with the base path and notification resource path specified in that API to construct an URL to which notification is sent. E.g. for &#x27;callback&#x27;: &quot;https://buyer.mplify.com/listenerEndpoint&quot;, the SFT event notification will be sent to: &#x60;https://buyer.mplify.com/listenerEndpoint /mefApi/legato/serviceFunctionTestingNotification/v3/&#x60;</td>
        </tr><tr>
        <td>query</td>
            <td>string</td>
            <td>O</td>
...
### 7.4.1.4. Type ResumeTestJobProcessStateChangeEvent
...
### 7.4.1.5. Type SuspendTestJobProcessStateChangeEvent
...
- [Mplify 136.1](https://www.mplify.net/wp-content/uploads/Mplify-136.1.pdf)
