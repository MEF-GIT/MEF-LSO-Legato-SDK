...
- [6. API Interactions and Flows](#6-api-interactions-and-flows)
  - [6.1. Use Case 1: Create a Fault Management Job](#61-use-case-1-create-a-fault-management-job)
    ...
    - [6.1.3. Schedule Definition](#613-schedule-definition)
    - [6.1.4. Create Fault Management Job Response](#614-create-fault-management-job-response)
    - [6.1.5. Fault Management Job State Machine](#615-fault-management-job-state-machine)
  ...
  - [6.17. Use Case 17: Register for Notifications](#617-use-case-17-register-for-notifications)
  - [6.18. Use Case 18: Send notification](#618-use-case-18-send-notification)
- [7. API Details](#7-api-details)
  ...
  - [7.2. Management API Data model](#72-management-api-data-model)
    ...
    - [7.2.2. FaultManagementReport](#722-faultmanagementreport)
      ...
      - [7.2.2.4. Type FaultManagementReportRef](#7224-type-faultmanagementreportref)
      - [7.2.2.5. `enum` FaultManagementReportStateType](#7225-enum-faultmanagementreportstatetype)
    - [7.2.3. Common](#723-common)
      - [7.2.3.1. Type AttachmentURL](#7231-type-attachmenturl)
      - [7.2.3.2. Type EntityRef](#7232-type-entityref)
      - [7.2.3.3. Type FmTrackingRecord](#7233-type-fmtrackingrecord)
      ...
      - [7.2.3.9. Type RelatedObjectRef](#7239-type-relatedobjectref)
      - [7.2.3.10. Type ReportContentItem](#72310-type-reportcontentitem)
      - [7.2.3.11. Type ReportingTimeframe](#72311-type-reportingtimeframe)
      - [7.2.3.12. `enum` ResultFormat](#72312-enum-resultformat)
      - [7.2.3.13. Type ScheduleDefinition](#72313-type-scheduledefinition)
      - [7.2.3.14. Type ServiceFromToRef](#72314-type-servicefromtoref)
      - [7.2.3.15. Type ServiceRef](#72315-type-serviceref)
      - [7.2.3.16. Type ServiceSpecificConfiguration](#72316-type-servicespecificconfiguration)
      - [7.2.3.17. Type ServiceSpecificResult](#72317-type-servicespecificresult)
      - [7.2.3.18. Type TerminationError](#72318-type-terminationerror)
      - [7.2.3.19. Type TimeDuration](#72319-type-timeduration)
      - [7.2.3.20. `enum` TimeDurationUnits](#72320-enum-timedurationunits)
...
are defined in [Mplify 133.1](#8-references). The requirements and use 
...
commit id:
[9a97094b30bf67c18f644bff017ab934673589c2](https://github.com/MEF-GIT/MEF-LSO-Allegro-SDK/tree/9a97094b30bf67c18f644bff017ab934673589c2)

- [`serviceApi/fm/faultManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Allegro-SDK/9a97094b30bf67c18f644bff017ab934673589c2/serviceApi/fm/faultManagement.api.yaml)
- [`serviceApi/fm/faultNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Allegro-SDK/9a97094b30bf67c18f644bff017ab934673589c2/serviceApi/fm/faultNotification.api.yaml)

[MEF-LSO-Interlude-SDK](https://github.com/MEF-GIT/MEF-LSO-Interlude-SDK)

commit id:
[2a08e04bd2ad6ef3d3d546a2dd62a11ba2cd13ca](https://github.com/MEF-GIT/MEF-LSO-Interlude-SDK/tree/2a08e04bd2ad6ef3d3d546a2dd62a11ba2cd13ca)

- [`serviceApi/fm/faultManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Interlude-SDK/2a08e04bd2ad6ef3d3d546a2dd62a11ba2cd13ca/serviceApi/fm/faultManagement.api.yaml)
- [`serviceApi/fm/faultNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Interlude-SDK/2a08e04bd2ad6ef3d3d546a2dd62a11ba2cd13ca/serviceApi/fm/faultNotification.api.yaml)

[MEF-LSO-Legato-SDK](https://github.com/MEF-GIT/MEF-LSO-Legato-SDK)

commit id:
[3314dd580fc2388d4fff2bbacbb5b45e0a120e46](https://github.com/MEF-GIT/MEF-LSO-Legato-SDK/tree/3314dd580fc2388d4fff2bbacbb5b45e0a120e46)

- [`serviceApi/fm/faultManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Legato-SDK/3314dd580fc2388d4fff2bbacbb5b45e0a120e46/serviceApi/fm/faultManagement.api.yaml)
- [`serviceApi/fm/faultNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Legato-SDK/3314dd580fc2388d4fff2bbacbb5b45e0a120e46/serviceApi/fm/faultNotification.api.yaml)


The Fault Management API is defined using [Open API 3.0](#8-references)
...
serves to provide the appropriate references from Mplify or external sources that 
...
| On-Demand							  | Fault Management Job actions that are initiated for a limited time to carry out the Fault Management measurements.																																																			                    | Mplify 133.1 																		 |
...
| Passive							  | Fault Management Job action to support the collection and reporting of network. The statistics collections include but are not limited to telemetry associated with an interface, (Net/Application) Flow, VLAN, bridging/Ethernet, IP, TCP, UDP layers.   															                                                                                                                                                                                | Mplify 133.1 																		                                                                                            |
| Proactive							  |	Fault Management Job actions that are carried on continuously to permit timely reporting of fault  status.																																																				                        | Mplify 133.1 																		 |
...
| FM	   | Fault Management   																		  | Mplify 133.1												 |
...
interpreted as described in BCP 14 ([RFC 2119](#8-references), [RFC 8174](#8-references)) when, and only when, they appear in all
...
The use cases and business requirements in this document assume a
...
cases that are defined in [Mplify 133.1](#8-references). Fault 
Management Use Cases must support the use of Mplify service fault indicators 
...
This Developer Guide does not define Mplify service fault management 
specifications but can be used in combination with any specifications defined 
by or compliant with Mplify. Fault management schemas are defined in other 
Mplify documents. 
...
- The Buyer/Client system triggers provisioning of Fault Management Job. 
- The SOF provisions Fault Management by creating a `FaultManagementJob` which contains the configuration of fault indicators for monitored object.
- `FaultManagementJob` also carries a configuration including granularity, reporting period, schedule definition, and output format.
- The `FaultManagementJob` is processed by the SOF as per the state transition rules described in [6.1.4.](#614-fault-management-job-state-machine)
- (optional) The SOF reports the `FaultManagementJob` state changes.
- On a scheduled date according to schedule definition, a `FaultManagementReport` entity is created and data generation is started.
- Fault data is collected in the `FaultManagementReport`.
- When the configured reporting period elapses, collection of results is completed.
- `FaultManagementReport` is processed as per the state transition rules described in [6.13.1.](#6131-fault-management-report-state-machine)
- (optional) The SOF reports the `FaultManagementReport` state change.
- The Buyer/Client system can collect `FaultManagementReport` through _Fault Management API_ 

The same _Fault Management API_ is used by the Buyer/Client to create **new**
...
Figure 6-8 present high-level use case diagrams. They aim to help understand
the endpoint mapping. Use cases are described extensively in
[chapter 6](#6-api-interactions-and-flows). The mandatory use cases are 
highlighted in bold.

![Figure 6: Use cases - Fault Management Job](media/fmUsecasesFaultManagementJob.png)

**Figure 6. Use cases - Fault Management Job**

![Figure 7: Use cases - Fault Management Report](media/fmUsecasesFaultManagementReport.png)

**Figure 7. Use cases - Fault Management Report**

![Figure 8: Use cases - Common](media/fmUsecasesCommon.png)

**Figure 8. Use cases - Common**
...
`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/allegro/faultManagement/v3/`

**Base URL for Interlude**:

`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/interlude/faultManagement/v3/`

**Base URL for Legato**:

`https://{{serverBase}}:{{port}}{{?/sof_prefix}}/mefApi/legato/faultManagement/v3/`
...
| GET /hub/{id}                   | The Buyer/Client retrieves a specific `EventSubscription` from the SOF, that matches the _`id`_ value provided as _`path`_ parameter. | 6                         |
...
`https://{{serverBase}}:{{port}}{{?/bus_cus_sof_prefix}}/mefApi/allegro/faultNotification/v3/`

**Base URL for Interlude**:

`https://{{serverBase}}:{{port}}{{?/bus_cus_sof_prefix}}/mefApi/interlude/faultNotification/v3`

**Base URL for Legato**:

`https://{{serverBase}}:{{port}}{{?/bus_cus_sof_prefix}}/mefApi/legato/faultNotification/v3/`
...
have subscribed to FM Notifications. [Mplify133.1 R36]
...
that uniquely identifies the fault management schemas. A unique 
identifier for Mplify standard service schemas is in URN format and is assigned 
by Mplify. This identifier is provided as root schema `$id`.
Use of non-Mplify standard fault management configuration is allowed. In such 
...
`reportContent` property. This entity has a `measurementData` array 
...
example of a static binding of the envelope API with exemplary Mplify fault 
...
ServiceSpecificConfiguration:
  ...
  description: ServiceSpecificConfiguration is used as an extension point
    for Mplify-specific service fault management configuration. The `@type` 
  ...
  properties:
    '@type':
      ...
      description:
        ...
        configuration. In the case of Mplify services, this is the URN provided in
...
ServiceSpecificResult:
  type: object
  description:
    ServiceSpecificResult is used as an extension point for Mplify-specific fault 
  ...
  properties:
    '@type':
      ...
      description:
        ...
        returned by the Fault Management Report. In the case of Mplify 
...
![Figure 9: Extension pattern](media/extensionPattern.png)

**Figure 9. The Extension Pattern with Sample Service-Specific Extension**

Figure 9 presents two Mplify Fault Management schemas that represent 
...
| 17         | Register for Fault Management Notifications           | The Buyer/Client requests to subscribe to Fault Management Notifications.                                                             |
| 18         | Send Event Notification                               | A request initiated by the Seller/Server to notify the Buyer/Client.                                                                                                 |
...
The flow of this use case is shown in Figure 10.

![Figure 10: Use Case 6](media/useCase1.png)

**Figure 10. Use Case 1 - Fault Management Job create request flow**
...
![Figure 11: Fault Management Job Notification](media/useCase1Notification.png)

**Figure 11. Fault Management Job progress tracking - Notifications**

![Figure 12: Fault Management Job Polling](media/useCase1Polling.png)

**Figure 12. Fault Management Job progress tracking - Polling**

The context of notifications is not a part of the considered use
...
Figure 13 presents the most important part of the data model used during
...
![Figure 13: Fault Management Job Key Entities](media/FaultManagementJobModel.png)

**Figure 13. Fault Management Job Key Entities**
...
provide the following attributes: [Mplify133.1 R1]
- `jobType`
- `granularity`'
- `monitoredObject`
- `reportingPeriod`
...
following attributes: [Mplify133.1 O1]
- `description`
- `jobPriority`

### 6.1.3. Schedule Definition

Schedule (configured by `ScheduleDefinition` object) specifies when and how
fault management jobs are executed. It includes a start time (`scheduleDefinitionStartTime`),
which if empty means the schedule starts immediately after job provisioning,
and an end time (`scheduleDefinitionEndTime`), which if not provided means 
the job runs indefinitely. The `executionDuration` defines how long 
each job execution lasts, which may result in multiple reports per execution
based on the reporting period. 
The `recurringSchedule` part defines the frequency of job's periodic execution
using a Cron-like syntax, allowing jobs to run at specified seconds, minutes,
hours, days, months, or weekdays.
This scheduling supports special characters such as:
- "*" (asterisk) - represents "any value" for the given field. 
  - For example, in the `minute` field, * means every minute.
  - * * * * * — run a job every second, of every minute, of every hour, and so forth.
...
- "-" (hyphen) - defines a range of values. 
  - For example, 9-17 in the `hour` field includes all hours from 9 AM to 5 PM inclusive.
...
- 0 */10 * * * * — runs a job every 10 minutes, at the start of the minute
...
### 6.1.4. Create Fault Management Job Response

Entities used for providing a response to Create Fault Management Job requests 
are presented in Figure 13. The Seller/Server responds with a `FaultManagementJob` 
...
The term "Response Code" used in the Business Requirements
...
```json
{
  ...
  "creationDateTime": "2025-01-01T00:00:00.000Z", << added by SOF >>
  "href": "{{baseUrl}}/faultManagement/v3/faultManagementJob/755e55e2-72b0-4e3b-af00-693e3beac691", << added by SOF >>
  "id": "755e55e2-72b0-4e3b-af00-693e3beac691", << added by SOF >>
  "lastTimeModified": "2025-01-01T00:00:00.000Z", << added by SOF >>
...
**[R11]** The Seller/Server **MUST** set the `creationDateTime` and `id` 
attribute. [Mplify133.1 R2]

**[R12]** The Seller’s/Server’s response **MUST** echo back all Buyer/Client 
provided attributes. [Mplify133.1 R3]

**[R13]** The FM Job Identifier supplied by the Seller/Server **MUST** be unique
within the Seller/Server’s system. [Mplify133.1 R4]
...
### 6.1.5. Fault Management Job State Machine

Figure 14 presents the Fault Management Job state machine:

![Figure 14: Fault Management Job State Machine](media/FaultManagementJobStates.png)

**Figure 14. Fault Management Job State Machine**
...
`FaultManagementJob.terminationError` acts as a placeholder to provide a
...
Table 8 presents the mapping between the API `status` names and the Mplify 133.1
...
and their associated transitions as described in Figure 14 and Table 8.
...
**[R17]** The Buyer/Client's Retrieve List of Fault Management Jobs request 
**MUST** contain none or more of the following attributes as filter criteria [Mplify133.1 R27]: 
...
```
https://serverRoot/mefApi/legato/faultManagement/v3/faultManagementJob?state=suspended&limit=20&offset=0
```
...
**[R19]** The Seller/Server’s response **MUST** include a list of Fault 
Management Job Identifiers that match the filter criteria. [Mplify133.1 R29]

**[R20]** In case no items matching the criteria are found, the Seller/Server 
**MUST** return a valid response with an empty list. [Mplify133.1 R30]
...
**[R21]** The Seller/Server MUST return full representation 
of `FaultManagementJob`. [Mplify133.1 R32]

**[R22]** In case `id` does not match a `FaultManagementJob` in 
...
![Figure 15: Use Case 4](media/useCase4.png)

**Figure 15. Use Case 4 - Modify Fault Management Job create request flow**
...
![Figure 16: Modify Fault Management Job Notification](media/useCase4Notification.png)

**Figure 16. Modify Fault Management Job progress tracking - Notifications**

![Figure 17: Modify Fault Management Job Polling](media/useCase4Polling.png)

**Figure 17. Modify Fault Management Job progress tracking - Polling**
...
Only those attributes of the Fault Management Job that should be 
...
![Figure 18: Modify Fault Management Job Key Entities](media/modifyFaultManagementJobModel.png)

**Figure 18. Modify Fault Management Job Key Entities**
...
**[R23]** The Buyer’s/Client’s Modify FM Job request **MUST** include the 
Fault Management Job Identifier. [Mplify133.1 R6]

**[R24]** The Buyer’s/Client’s Modify FM Job request **MUST** contain one 
or more of the following attributes: [Mplify133.1 R7]
- `description`
- `granularity`
- `jobPriority`
- `outputFormat`
...
are presented in Figure 18. The Seller/Server responds with a 
...
```json
{
  ...
  "creationDateTime": "2025-01-02T00:00:00.000Z", << added by SOF >>
  "href": "{{baseUrl}}/faultManagement/v3/modifyFaultManagementJob/9c51d971-185d-403e-952f-2110f33a9628", << added by SOF >>
...
request **MUST** echo back the attributes in the Client’s request. [Mplify133.1 R8]
...
Figure 19 presents the Modify Fault Management Job state machine:

![Figure 19: Modify Fault Management Job State Machine](media/modifyFaultManagementJobStates.png)

**Figure 19. Modify Fault Management Job State Machine**
...
Table 9 presents the mapping between the API `status` names and the Mplify 133.1
...
statuses and their associated transitions as described in Figure 19 and Table 9. 
...
**[O4]** The Buyer/Client Retrieve List of Modify Fault Management Jobs request 
...
**[R29]** In case no items matching the criteria are found, the Seller/Server 
...
**[R30]** In case `id` does not match a `ModifyFaultManagementJob` in 
Seller/Server's system, an error response `Error404` **MUST** be returned. 

**[R31]** The Seller/Server **MUST** include following attributes in the
...
**[R32]** The Seller **MUST** provide all remaining optional attributes if they
...
**[R33]** The Buyer’s/Client’s Cancel FM Job request **MUST** include 
the FM Job Identifier. [Mplify133.1 R10]
...
```json
{
  ...
  "creationDateTime": "2025-01-02T00:00:00.000Z", << added by SOF >>
  "href": "{{baseUrl}}/faultManagement/v3/cancelFaultManagementJob/aea2769a-23f3-4ddc-b095-542a63b12481", << added by SOF >>
...
**[R36]** The `id` **MUST** remain the same value for the life of the Cancel 
Fault Management Job.

**[R37]** If the Seller/Server accepts the Buyer’s/Client’s Cancel FM Job 
request, the Job **MUST** stop. [Mplify133.1 R12]

**[R38]** If the Seller/Server declines the Buyer’s/Client’s Cancel FM Job 
request, the Job **MUST NOT** stop. [Mplify133.1 R13]

**[R39]** If the Seller/Server declines the Client’s Cancel FM Job request,
they **MUST** provide a reason the request was declined. [Mplify133.1 R14]
...
**[O5]** The Buyer/Client Retrieve List of Cancel Fault Management Jobs request 
**MAY** contain none or more of the following attributes: 
...
**[R40]** In case no items matching the criteria are found, the Seller/Server 
**MUST** return a valid response with an empty list. 
...
**[R41]** In case `id` does not match a `CancelFaultManagementJob` in 
Seller/Server's system, an error response `Error404` **MUST** be returned. 
...
The sequence diagram in Figure 25 presents this use case in detail.

![Figure 25: Use Case 10](media/useCase10.png)

**Figure 25. Use Case 10 - Suspend Fault Management Job Flow**
...
**[R44]** In case `id` does not match a `FaultManagementJob` that is to be
suspended, an error response `Error404` **MUST** be returned. 

**[R45]** The FM Job **MUST** be in the `inProgress` state to be suspended. [Mplify133.1 R16]

**[R46]** If the Seller/Server accepts the Client’s Suspend FM Job request,
the job **MUST** be suspended. [Mplify133.1 R18]

**[R47]** If the Seller/Server declines the Buyer/Client’s suspend FM Job 
request, the job **MUST NOT** be suspended. [Mplify133.1 R19]

**[R48]** If the Seller/Server declines the Buyer/Client’s request to suspend 
a Fault Management Job, they **MUST** provide an Error with a meaningful 
explanation in `reason` field. [Mplify133.1 R20]
...
![Figure 26: Use Case 11](media/useCase11.png)

**Figure 26. Use Case 11 - Resume Fault Management Job Flow**
...
**[R49]** In case `id` does not match a `FaultManagementJob` 
that is to be resumed, an error response `Error404` **MUST** be returned. 

**[R50]** The FM Job **MUST** be in the `suspended` state. [Mplify133.1 R22]

**[R51]** If the Seller/Server accepts the Client’s Resume FM Job request, 
the job **MUST** be resumed and return to the `inProgress` or `scheduled` state. [Mplify133.1 R24]

**[R52]** If the Seller/Server declines the Buyer/Client’s Resume FM Job 
request, the FM Job **MUST NOT** be resumed. [Mplify133.1 R25]

**[R53]** If the Seller/Server declines the Buyer/Client’s request to resume
a Fault Management Job, they **MUST** provide an Error with a meaningful 
explanation in `reason` field. [Mplify133.1 R26]
...
Figure 27 depicts the key components of the data model utilized in the 
...
![Figure 27: Fault Management Job Complex Query Key Entities](media/FaultManagementJobComplexQueryModel.png)

**Figure 27. Fault Management Job Complex Query Key Entities**
...
**[R54]** The Buyer/Client's Fault Management Job Complex Query request 
**MUST** contain none or more of the following attributes as filter criteria [Mplify133.1 R27]: 
...
[
  {
    ...
    "href": "{{baseUrl}}/faultManagement/v3/faultManagementJobComplexQuery/755e55e2-72b0-4e3b-af00-693e3beac691", 
    "id": "755e55e2-72b0-4e3b-af00-693e3beac691", 
    "jobPriority": 5,
    "jobType": "on-demand",
    "lastTimeModified": "2025-01-01T00:00:00.000Z", 
    "monitoredObject": {
      "@type": "ServiceRef",
      "serviceId": "905d9f87-6478-4153-a5de-fcc70257f03c",
    },
...
**[O6]** The Buyer’s/Client’s Retrieve List of Fault Management Reports request 
...
**[R55]** The Seller/Server's response to the Buyer’s/Client’s retrieve List 
of Fault Management Reports **MUST** include the following attributes as 
applicable: [Mplify133.1 R41]
...
**[O7]** The Seller/Server’s response to the Buyer/Client’s retrieve List 
of Fault Management Reports **MAY** include `description`. [Mplify133.1 O3]

**[R56]** In case no items matching the criteria are found, the Seller/Server 
**MUST** return a valid response with an empty list. [Mplify133.1 R42]

Figure 28 presents entities related to the use case. 

![Figure 28: Use Case 13](media/useCase13Model.png)

**Figure 28. Use Case 13: Retrieve Fault Management Report List - Model**

### 6.13.1. Fault Management Report State Machine

Figure 29 presents the Fault Management Report state machine:

![Figure 29: Fault Management Report State Machine](media/faultManagementReportStates.png)

**Figure 29. Fault Management Report State Machine**
...
The `FaultManagementReport.terminationError` acts as a placeholder to provide 
...
**[R57]** The Seller/Server **MUST** support all Fault Management Report 
statuses and their associated transitions as described in Figure 29 and Table 10. 
...
```json 
{
  "creationDateTime": "2025-01-01T01:00:00.000Z",
  ...
  "reportContent": [
    {
      "measurementTime": {
        ...
        "measurementEndDate": "2025-01-01T00:30:00.000Z"
      },
      "measurementData": [
        {
	...
	{
      "measurementTime": {
        "measurementStartDate": "2025-01-01T00:30:00.000Z",
      ...
      "measurementData": [
        {
          ...
          "countOfLostPackets": 0,
          "percentageOfLostPackets": 0.0
        }
      ]
    }
  ],
...
The above snippet contains the content of a `FaultManagementReport` produced 
by a `FaultManagementJob` with the following configuration:
- Job is scheduled to run between 2025-01-01 00:00:00 and 2026-01-01 00:00:00.00
- Schedule recurrence: every two hours, at the start of the hour, every day
- Duration of a single job execution: 1 hour
- Sampling granularity: 30 minutes
- Reporting period: 1 hour

Based on this configuration, the `FaultManagementJob` started at 2025-01-01 00:00:00.
Since the granularity is 30 minutes, the first sample was taken at 00:30. 
The reporting period is 1 hour, so two samples were included in the report:
one from 00:30 and another from 01:00.
After this period, the report was completed, and its status changed to `completed`.
The `FaultManagementJob` transitioned to the `scheduled` state and is awaiting
2025-01-01 02:00:00 to begin collecting data for the next report.
Collection of each sample involved executing a ping command between the source
and destination IP addresses using 10 packets.

The `FaultManagementReport` entity is created when the `FaultManagementJob` 
begins processing and generating data. As samples become available, they are
added to the report. Until the report is `completed`, it may not return 
measurement data, depending on the implementation. However, once marked 
as `completed`, the report must return the available measurement data. Querying
an incomplete report may be necessary in cases where the reporting period 
is long but some samples are already available for retrieval.

**[R58]** The Seller/Server **MUST** include following attributes in the
...
**[R59]** The Seller/Server **MUST** provide all remaining optional attributes 
if they were previously set by the Buyer or the Seller. 

**[R60]** The results regardless of the format **MUST** contain the FM results
as specified with FM Job request. [Mplify133.1 R43]

**[R61]** In case `id` does not match `FaultManagementReport` in 
Seller/Server's system, an error response `Error404` **MUST** be returned. 
...
![Figure 30: Fault Management Report Complex Query Key Entities](media/FaultManagementReportComplexQueryModel.png)

**Figure 30. Fault Management Report Complex Query Key Entities**
...
```json
{
  "creationDateTime.gt": "2025-01-01T00:00:00.000Z",
  "creationDateTime.lt": "2025-01-02T00:00:00.000Z",
  "outputFormat": "json",
  "serviceRef": {
    "serviceId": "905d9f87-6478-4153-a5de-fcc70257f03c"
  },
...
`FmTrackingRecord` type.

The Buyer/Client can retrieve a list of `FmTrackingRecord` by using a 
...
- `relatedFaultManagementJobId`
- `relatedFaultManagementReportId`
- `creationDateTime.gt`
- `creationDateTime.lt`

The Buyer may also ask for pagination with the use of the `offset` and `limit`
parameters. Section[6.2](#62-use-case-2-retrieve-list-of-fault-management-job)
provides details about the implementation of pagination mechanism.

**[R62]** The Seller/Server **MUST** include following attributes (if set) in 
the `FmTrackingRecord` object in the response: 
- `creationDateTime`
- `id`
- `relatedObjectId`

**[R63]** Optionally The Seller/Server **MAY** return : 
- `description`
- `request`
- `source`
...
Figure 31 presents the main Tracking Record entities. 

![Figure 31: Tracking Record Model](media/trackingRecordModel.png)

**Figure 31. Tracking Record Model**

## 6.17. Use Case 17: Register for Notifications
...
notifications is presented in Figure 32. 

![Figure 32: Fault Management Notification Example](media/useCase1Notification.png)

**Figure 32. Fault Management Notification Example**
...
Figure 33 shows all entities involved in the notification use cases.

![Figure 33: Fault Management Notification Data Model](media/faultManagementNotificationModel.png)

**Figure 33. Fault Management Notification Data Model**
...
**[R65]** The Client request **MUST** contain the following: [Mplify133.1 R33]
- `callback`

**[O9]** The Buyer/Client request **MAY** contain the `query` parameter. [Mplify133.1 O2]

**[R66]** If the Seller/Server rejects the Client’s Register for FM 
Notifications request, the response **MUST** include a reason for the rejection. [Mplify133.1 R35]
...
The `query` formatting complies with [RFC 3986](#8-references).
...
`https://bus.mplify.com/listenerEndpoint/mefApi/legato/faultNotification/v3/listener/faultManagementJobStateChangeEvent`

## 6.18. Use Case 18: Send notification

Notifications are used to asynchronously inform the Buyer/Client about the 
respective objects and attributes changes.

Figure 34 presents notifications produced by Seller/Server for the whole lifecycle
of `FaultManagementJob` assuming that Buyer/Client subscribed to all event types.

![Figure 34: Fault Management Job lifecycle](media/notificationsForFaultManagementJob.png)

**Figure 34. Fault Management Job lifecycle with all notifications**
...
The body of the event doesn't contain all details of the object. 
The Buyer/Client needs to query it later by `id` to get details. 

The state change notification is sent only when the state
...
who have subscribed to FM Notifications. [Mplify133.1 R36]

**[R68]** The Seller/Server FM Notifications **MUST NOT** be sent 
to Buyer/Clients who have not subscribed to FM Notifications. [Mplify133.1 R37]

**[R69]** The Seller/Server’s FM Notification **MUST** include the following
attributes: [Mplify133.1 R38]
- `eventType`
- `eventId`
- `eventTime`
- `event` 
...
**MUST** notify the Buyer/Client when FM Job results are available. [Mplify133.1 R5]
...
compliance with rules defined in [RFC7231](#8-references). In such a
case, the error message body structure might be aligned with the `Error`.

![Figure 35: Error response data model](media/errorEntities.png)

**Figure 35. Data model types to represent an erroneous response**
...
Figure 36-42 presents the full Fault Management data model. The data types,
requirements related to them, and mapping to Mplify 133.1 specification are
discussed later in this section.

![Figure 36: Fault Management Data Model - Fault Management Job Entities](media/faultManagementDataModel.png)
**Figure 36. Fault Management Data Model - Fault Management Job Entities**

![Figure 37: Fault Management Data Model - Query Fault Management Job Entities](media/faultManagementDataModelPart2.png)
**Figure 37. Fault Management Data Model - Query Fault Management Job Entities**

![Figure 38: Fault Management Data Model - Fault Management Job Process Entities](media/faultManagementDataModelPart3.png)
**Figure 38. Fault Management Data Model - Fault Management Job Process Entities**

![Figure 39: Fault Management Data Model - Fault Management Report Entities](media/faultManagementDataModelPart4.png)
**Figure 39. Fault Management Data Model - Fault Management Report Entities**

![Figure 40: Fault Management Data Model - Query Fault Management Report Entities](media/faultManagementDataModelPart5.png)
**Figure 40. Fault Management Data Model - Query Fault Management Report Entities**

![Figure 41: Fault Management Data Model - Tracking Record and Event Subscription Entities](media/faultManagementDataModelPart6.png)
**Figure 41. Fault Management Data Model - Tracking Record and Event Subscription Entities**

![Figure 42: Fault Management Data Model - Error Entities](media/faultManagementDataModelPart7.png)
**Figure 42. Fault Management Data Model - Error Entities**
...
<table id="T_FaultManagementJob_Create">
    ...
    <tbody>
        <tr>
            ...
            <td>ServiceSpecificConfiguration is used as an extension point for  Mplify-specific service fault management configuration.</td>
...
<table id="T_FaultManagementJob">
    ...
    <tbody>
        <tr>
            ...
            <td>state*</td>
            <td><a href="#T_FaultManagementJobStateType">FaultManagement JobStateType</a></td>
...
<table id="T_CancelFaultManagementJob">
    ...
    <tbody>
        <tr>
            ...
            <td>FM Job Cancellation Process Identifier</td>
        </tr><tr>
            <td>state*</td>
            <td><a href="#T_FaultManagementJobProcessStateType">FaultManagement JobProcessStateType</a></td>
            <td>The state of the process related to the Fault Management Job.</td>
            <td>FM Job Cancellation Process State</td>
        </tr>
    </tbody>
</table>
...
<table id="T_ModifyFaultManagementJob_Create">
    ...
    <tbody>
        <tr>
            ...
            <td>faultManagement Job*</td>
            <td><a href="#T_FaultManagementJobRef">FaultManagement JobRef</a></td>
            <td>A reference to a Fault Management Job resource.</td>
            <td>FM Job Identifier</td>
        </tr><tr>
            <td>granularity</td>
...
<table id="T_ModifyFaultManagementJob">
    ...
    <tbody>
        <tr>
            ...
            <td>FM Job Modification Process Identifier</td>
        </tr><tr>
            <td>state*</td>
            <td><a href="#T_FaultManagementJobProcessStateType">FaultManagement JobProcessStateType</a></td>
            <td>The state of the process related to the Fault Management Job.</td>
...
| `rejected`              | Rejected                | A Create Fault Management Job request fails validation and is rejected with error indications by the Seller/Server.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `resources Unavailable`  | Resources Unavailable   | A Fault Management Job cannot be allocated necessary resources when moving to execution (In-Progress state).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
<table id="T_FaultManagementReport">
    ...
    <tbody>
        <tr>
            ...
            <td>serviceSpecific Configuration*</td>
            <td><a href="#T_ServiceSpecificConfiguration">ServiceSpecific Configuration</a></td>
            <td>ServiceSpecificConfiguration is used as an extension point for Mplify-specific fault management configuration. </td>
            <td>Service Specific Configuration</td>
        </tr><tr>
            <td>state*</td>
            <td><a href="#T_FaultManagementReportStateType">FaultManagemen tReportStateType</a></td>
...
<table id="T_FaultManagementReport_Find">
    ...
    <tbody>
        <tr>
            ...
            <td>state*</td>
            <td><a href="#T_FaultManagementReportStateType">FaultManagement ReportStateType</a></td>
            <td>Possible values for the state of a Fault Management Report.</td>
            <td>State</td>
        </tr>
    </tbody>
...
#### 7.2.2.4. Type FaultManagementReportRef
...
#### 7.2.2.5. `enum` FaultManagementReportStateType
...
<table id="T_TrackingRecord">
    ...
    <tbody>
        <tr>
            ...
            <td>Reference to the Fault Management Job or Report for which the Tracking Record was created.</td>
...
**Description:** A definition of recurring schedule to run a job based on the Cron utility in Linux-like systems. It defines how the job should periodically run at specified times, dates, or intervals. Special characters can be used in the definition of individual fields, such as:
  - &#x60;*&#x60; -&gt; any value
...
For example: <br/>
  - */5 * * * * * -&gt; run a job at every 5th second. <br/>
  - */30 */1 * * * * -&gt; run a job at every 30 seconds past every minute.</td>
            <td>Second</td>
        </tr><tr>
            <td>minute</td>
            <td>string</td>
            <td>A definition of time (minutes) to run a job. Allowed values: 0-59,  and special characters: (,-*/). <br/>
For example: <br/>
  - 0 */10 * * * * -&gt; run a job at every 10th minute. <br/>
  - 0 */30 0 * * * -&gt; run a job at every 30th minute past midnight. <br/>
  - 0 */30 8 * * 1 -&gt; run a job at every 30th minute past hour 8 on Monday.</td>
            <td>Minute</td>
        </tr><tr>
            <td>hour</td>
            <td>string</td>
            <td>A definition of time (hours) to run a job. Allowed values: 0-23,  and special characters: (,-*/). <br/>
For example: <br/>
  - 0 0 10 10 * * -&gt; run a job 10 am on 10th day of every month. <br/>
  - 0 * 1,2 * * * -&gt; run a job at every minute past hour 1 and 2. <br/>
  - 0 0 */2 * * * -&gt; run a job at every 2nd hour.</td>
            <td>Hour</td>
        </tr><tr>
            <td>dayOfMonth</td>
            <td>string</td>
            <td>A definition of time (day of month) to run a job.  Allowed values: 1-31, and special characters: (,-*/). <br/>
For example: <br/>
  - 0 0 0 1,5,10,15 * * -&gt; run a job at midnight on every 1st, 5th, 10th, 15th day of month. <br/>
  - 0 0 */1 1-10 1-3 * -&gt; run a job at every full hour between 1st and 10th day of month in January, February, and March.</td>
            <td>Day of Month</td>
        </tr><tr>
            <td>month</td>
            <td>string</td>
            <td>A definition of time (month) to run a job. Allowed values: 1-12 or JAN-DEC, and special characters: (,-*/). <br/>
For example: <br/>
  - 0 5 0 * 8 * -&gt; run a job at 00:05 on every day in August. <br/>
  - 0 0 0,12 1 */2 * -&gt; run a job at midnight and noon on every 1st day of every 2nd month.</td>
            <td>Month</td>
        </tr><tr>
            <td>dayOfWeek</td>
            <td>string</td>
            <td>A definition of time (day of week) to run a job. Allowed values: 0-6 or SUN-SAT, and special characters: (,-*/). <br/>
For example: <br/>
  - 0 0 22 * * 1-5 -&gt; run a job at 22:00 on every day between Monday and Friday. <br/>
...
#### 7.2.3.11. Type ReportingTimeframe
...
#### 7.2.3.13. Type ScheduleDefinition
...
#### 7.2.3.14. Type ServiceFromToRef
...
#### 7.2.3.16. Type ServiceSpecificConfiguration

**Description:** ServiceSpecificConfiguration is used as an extension point for  Mplify-specific service fault management configuration. The `@type`  attribute is used as a discriminator.
<table id="T_ServiceSpecificConfiguration">
    ...
    <tbody>
        <tr>
            <td>@type*</td>
            <td>string</td>
            <td>Uniquely identifies the type of fault management job configuration. In the case of Mplify services, this is the URN provided in the fault management configuration specification. The named type must be a  subclass of ServiceSpecificConfiguration.</td>
            <td>Not present</td>
        </tr>
    </tbody>
</table>

#### 7.2.3.17. Type ServiceSpecificResult

**Description:** ServiceSpecificResult is used as an extension point for Mplify-specific fault  management job results. The `@type` attribute is used as a discriminator.
<table id="T_ServiceSpecificResult">
    ...
    <tbody>
        <tr>
            <td>@type*</td>
            <td>string</td>
            <td>The name that uniquely identifies the type of results that are returned by the Fault Management Report. In the case of Mplify  services, this is the URN provided in the fault management results specification. The named type must be a subclass of ServiceSpecificResult.</td>
            <td>Not present</td>
        </tr>
    </tbody>
</table>

#### 7.2.3.18. Type TerminationError

**Description:** This indicates an error that caused a FM Job or FM Report to be terminated. The code and propertyPath should be used like in Error422.
...
#### 7.2.3.20. `enum` TimeDurationUnits
...
<table id="T_EventSubscriptionInput">
    ...
    <tbody>
        <tr>
            <td>callback*</td>
            <td>string</td>
            <td>This callback value must be set to the *host* property from Fault  Management Notification API (faultNotification.api.yaml). This property is appended with the base path and notification resource path specified in that API to construct a URL to which notification is sent. E.g. for &#x27;callback&#x27;:  &quot;https://bus.mplify.com/ listenerEndpoint&quot;, the Fault Management Job state change event notification will be sent to &#x60;https://bus.mplify.com/listenerEndpoint/ mefApi/legato/faultManagement/v3 /listener/faultManagementJobStateChangeEvent&#x60;</td>
...
Figure 43 presents the Fault Management Notification data model.

![Figure 43: Fault Management Notification Data Model](media/faultManagementNotificationModel.png)

**Figure 43. Fault Management Notification Data Model**
...
<table id="T_Event">
    ...
    <tbody>
        <tr>
            ...
            <td>FM Notification Identifier</td>
        </tr><tr>
            <td>eventTime*</td>
            <td>date-time</td>
...
<table id="T_FaultManagementJobCreateEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_FaultManagementJobEventPayload">FaultManagement JobEventPayload</a></td>
            <td>A reference to the Fault Management Job that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
</table>
...
<table id="T_FaultManagementJobStateChangeEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_FaultManagementJobStateChangeEventPayload">FaultManagement JobStateChangeEventPayload</a></td>
            <td>A reference to the Fault Management Job that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
...
<table id="T_FaultManagementJobReportReadyEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_FaultManagementJobReportReadyEventPayload">FaultManagement JobReportReadyEventPayload</a></td>
            <td>A reference to the Fault Management Job that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
...
<table id="T_FaultManagementJobReportPreparationErrorEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_FaultManagementJobReportPreparationErrorEventPayload">FaultManagement JobReportPreparationError EventPayload</a></td>
            <td>A reference to the Fault Management Job that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
...
<table id="T_CancelFaultManagementJobStateChangeEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_CancelFaultManagementJobStateChangeEventPayload">CancelFaultManagement JobStateChangeEventPayload</a></td>
            <td>A reference to the Cancel Fault Management Job that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
</table>
...
<table id="T_ModifyFaultManagementJobStateChangeEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_ModifyFaultManagementJobStateChangeEventPayload">ModifyFaultManagement JobStateChangeEventPayload</a></td>
            <td>A reference to the Modify Fault Management Job that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
</table>
...
<table id="T_ModifyFaultManagementJobStateChangeEventPayload">
    ...
    <tbody>
        <tr>
            ...
            <td>FM Job Modification Process State</td>
        </tr>
    </tbody>
</table>
...
<table id="T_FaultManagementReportCreateEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_FaultManagementReportEventPayload">FaultManagement ReportEventPayload</a></td>
            <td>A reference to the Fault Management Report that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
</table>
...
<table id="T_FaultManagementReportStateChangeEvent">
    ...
    <tbody>
        <tr>
            ...
            <td>event*</td>
            <td><a href="#T_FaultManagementReportStateChangeEventPayload">FaultManagement ReportStateChangeEventPayload</a></td>
            <td>A reference to the Fault Management Report that is source of the notification.</td>
            <td>Event</td>
        </tr>
    </tbody>
...
- [Mplify 133.1](https://www.mplify.net/wp-content/uploads/Mplify-133.1.pdf)
  Allegro, Interlude and Legato Fault Management and Alarm API BR&UC, October 2025
