...
the use of any of Mplify service specifications as payload, in particular,
those defined in:
...
Figure 5 presents two Mplify `<<ServiceSpecifications>>` that represent IPVC
and IPVC Endpoint services. When these services are used as a Service payload
...
<table id="T_Service" style="width:100%">
    ...
    <tbody>
        ...
        <td>serviceOrderItem</td>
            <td><a href="#T_ServiceOrderItemRef">Service OrderItemRef</a>[]</td>
            <td>O</td>
...
![Service Order Management Notification Data Model](media/serviceNotificationModel.png)
